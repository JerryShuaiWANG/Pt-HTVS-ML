...
def MainRegression(in_file_path, saved_dir, feature_selector_list, select_des_num_list, test_file_path=None, model_list=("RF",), 
    ...
    dataset_test= pd.read_csv("external_with_few_SOL_des_elecneg_topo_clean.csv")

    # features_list = ["Exp. emission energy","FpDensityMorgan1","HeavyAtomMolWt","FpDensityMorgan2","BalabanJ","HallKierAlpha","FpDensityMorgan3",\
    #     "fr_bicyclic","FractionCSP3","Kappa3","Kappa1","TPSA","NumHeteroatoms","Chi1","Chi0","kappa3","LabuteASA","phi","Kappa2","fr_aryl_methyl",\
    #         "fr_halogen","refractive_index","max_bond_order_coor_0","kappa2","max_bond_order_coor_1","E_T(30)","fr_para_hydroxylation","fr_methoxy",\
    #             "fr_ether","fr_aniline","NumAromaticHeterocycles","NumHAcceptors","NumAromaticRings","sum_delta_X_coor_2","fr_NH0","fr_Ar_N","state",\
    #                 "max_bond_order_coor_2","NumAromaticCarbocycles","NumAliphaticHeterocycles","max_delta_X_coor_0","fr_thiophene","NumRotatableBonds",\
    #                     "fr_ketone","RingCount","max_delta_X_coor_1","kappa1","sum_delta_X_coor_1","NumAliphaticCarbocycles",
    # ] #totally 48 fea and 1 target
    features_list = ['Exp. emission energy','FpDensityMorgan1','HeavyAtomMolWt','FpDensityMorgan2','BalabanJ','HallKierAlpha','FpDensityMorgan3','fr_bicyclic','FractionCSP3','Kappa3',\
        'Kappa1','TPSA','NumHeteroatoms','Chi1','Chi0','kappa3','LabuteASA','phi','Kappa2','fr_aryl_methyl','fr_halogen','refractive_index',\
            'max_bond_order_coor_0','kappa2','max_bond_order_coor_1','E_T(30)','fr_para_hydroxylation','fr_methoxy','fr_ether','fr_aniline',\
                'NumAromaticHeterocycles','NumHAcceptors','NumAromaticRings','sum_delta_X_coor_2','fr_NH0','fr_Ar_N','state','max_bond_order_coor_2',\
                    'NumAromaticCarbocycles','NumAliphaticHeterocycles','max_delta_X_coor_0','fr_thiophene','NumRotatableBonds','fr_ketone','RingCount',\
                        'max_delta_X_coor_1','kappa1','sum_delta_X_coor_1','NumAliphaticCarbocycles']
    dataset = dataset[features_list]
    dataset_test = dataset_test[features_list]
...
###########Regression################
    ...
    des_type = ('')
    # des_type = ("ecfp4",)
    random_state_list = (225,)
    # random_state_list = (i for i in range(0,501))
    # random_state_list = (42,)
    feature_selector_list = ("RFE",)
    select_des_num_list = (48,)#totally 46 with Cal. Kr, less totally 24, leaset 15
    model_list = ("LGBM", )
    # model_list = ("SVM","ADA", )
    # model_list = ("XGB","SVM","LGBM","RF","KNND","KNNU","KRR","ADA", )
