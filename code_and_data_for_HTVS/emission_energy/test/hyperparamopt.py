            ...
            "fr_halogen","refractive_index","max_bond_order_coor_0","kappa2","max_bond_order_coor_1","E_T(30)","fr_para_hydroxylation","fr_methoxy",\
                "fr_ether","fr_aniline","NumAromaticHeterocycles","NumHAcceptors","NumAromaticRings","sum_delta_X_coor_2","fr_NH0","fr_Ar_N","state",\
                    "max_bond_order_coor_2","NumAromaticCarbocycles","NumAliphaticHeterocycles","max_delta_X_coor_0","fr_thiophene","NumRotatableBonds",\
                        "fr_ketone","RingCount","max_delta_X_coor_1","kappa1","sum_delta_X_coor_1","NumAliphaticCarbocycles","min_bond_order_coor_0", "min_bond_order_coor_1",\
...
###########Regression################
    ...
    feature_selector_list = ("RFE",)
    select_des_num_list = (50,)#totally 46 with Cal. Kr, less totally 24, leaset 15
    model_list = ("LGBM", )
    # model_list = ("SVM","ADA", )
