...
def MainRegression(in_file_path, saved_dir, feature_selector_list, select_des_num_list, test_file_path=None, model_list=("RF",), 
    ...
    features_list = ["s1_t1_gap","BalabanJ","fr_bicyclic","FractionCSP3","HallKierAlpha","FpDensityMorgan1","Kappa2", \
    "FpDensityMorgan2","FpDensityMorgan3","fr_para_hydroxylation","NumAliphaticHeterocycles","HeavyAtomMolWt", \
        "TPSA","Kappa3","sum_bond_order_coor_3","fr_pyridine","kappa3","NumAliphaticCarbocycles","coor_1_atomic_No.",\
            "E_T(30)","Kappa1","NumAromaticCarbocycles","max_delta_X_coor_1","phi","NumAromaticHeterocycles","Chi0","fr_aryl_methyl",\
                "NumRotatableBonds","kappa2","LabuteASA","min_delta_X_coor_2","NumHeteroatoms","fr_NH0","fr_halogen","Chi1","fr_aniline",\
                    "coor_0_atomic_No.","RingCount","max_bond_order_coor_3",
    ] #totally 38 fea and 1 target
...
###########Regression################
    ...
    des_type = ('')
    # des_type = ("ecfp4",)
    random_state_list = (283,)
    # random_state_list = (i for i in range(100,1001))
    # random_state_list = (42,)
    feature_selector_list = ("RFE",)
    select_des_num_list = (153,)#totally 46 with Cal. Kr, less totally 24, leaset 15
    model_list = ("LGBM",)
    # model_list = ("SVM","ADA", )
